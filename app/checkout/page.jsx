                         ...
                         <div>
                              ...
                              <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-4">
                                   ...
                                   <div>
                                        ...
                                        <input type="text" inputMode="numeric" name="zipLevel" required maxLength={6} className="w-full border border-gray-200 rounded p-2 focus:ring-primary focus:border-primary" value={formData.zipLevel} onChange={handleChange} onBlur={handleBlur} />
                                   </div>
