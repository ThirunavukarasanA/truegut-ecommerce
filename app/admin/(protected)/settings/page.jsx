...
import {
     ...
     MdSave, MdLanguage, MdCurrencyRupee, MdLock
} from "react-icons/md";
...
export default function SettingsPage() {
     ...
     const [activeTab, setActiveTab] = useState(searchParams.get("tab") || "Store Profile");
     ...
     return (
          <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
               <AdminPageHeader
                    ...
                    primaryAction={activeTab !== "Security" ? {
                         ...
                         {activeTab === "Store Profile" && (
                              <AdminCard className="max-w-4xl">
                                   <div className="flex items-center gap-4 mb-8">
                                        ...
                                        <div>
                                             <h3 className="text-xl font-bold text-gray-900 leading-none">Business Identity</h3>
                                             <p className="text-sm text-gray-400 mt-1">Basic information about your store</p>
                                        </div>
                                   </div>
                         ...
                         {activeTab === "Regional Config" && (
                              <AdminCard className="max-w-4xl">
                                   <div className="flex items-center gap-4 mb-8">
                                        ...
                                        <div>
                                             <h3 className="text-xl font-bold text-gray-900 leading-none">Regional config</h3>
                                             <p className="text-sm text-gray-400 mt-1">Currency and localization preferences</p>
                                        </div>
                                   </div>

                                   <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="p-8 rounded-3xl bg-gray-50/50 border border-gray-100 space-y-4">
                                             <p className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 font-bold">Primary Currency</p>
                                             <div className="flex items-center justify-between">
                                                  <span className="text-3xl font-light text-gray-900">{settings.currency.code}</span>
                                                  <span className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-xl font-bold border border-gray-100 shadow-sm text-orange-600">{settings.currency.symbol}</span>
                                             </div>
                                             <p className="text-xs text-gray-500 bg-white p-3 rounded-xl border border-gray-100/50 font-light">
                                                  This is the currency used for all sales records and customer-facing prices.
                                             </p>
                                        </div>
                                        ...
                                        <div className="p-8 rounded-3xl border border-dashed border-gray-200 flex flex-col items-center justify-center text-center space-y-3 opacity-60">
                                             ...
                                             <p className="text-xs font-medium text-gray-500">Multi-currency Support</p>
                                             <p className="text-[10px] text-gray-400 uppercase tracking-widest font-light">Feature coming soon</p>
                                        </div>
                                   </div>
                              </AdminCard>
                         )}
                         ...
                         {activeTab === "Security" && (
                              <AdminCard className="max-w-4xl">
                                   <div className="flex items-center gap-4 mb-8">
                                        ...
                                        <div>
                                             <h3 className="text-xl font-bold text-gray-900 leading-none">Access & Safety</h3>
                                             <p className="text-sm text-gray-400 mt-1">Update your administrative credentials</p>
                                        </div>
                                   </div>
                                   ...
                                   <form onSubmit={handleChangePassword} className="space-y-6">
                                        ...
                                        >
                                             <MdLock size={18} className="group-hover:rotate-12 transition-transform" />
