  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const uploadRes = await fetch("/api/admin/upload", {
        method: "POST",
        body: uploadData,
        // adminFetch doesn't handle FormData easily if it sets content-type to application/json,
        // assuming standard fetch works if auth cookie is present
      });
      ...
      toast.loading("Saving banner...", { id: toastId });
      ...
      const saveRes = await adminFetch("/api/admin/banners", {
        method: "POST",
      ...
      if (saveRes.success) {
        ...
        throw new Error(saveRes.error || "Failed to save banner");
      }
    } catch (error) {
