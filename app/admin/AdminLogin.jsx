          ...
          <div className="min-h-screen flex items-center justify-center bg-gray-50 relative overflow-hidden">
               ...
               <div className="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-gray-200 w-full max-w-md relative z-10 border border-gray-100 animate-in fade-in zoom-in-95 duration-500">
                    ...
                    <div className="flex flex-col items-center mb-10">
                         ...
                         <h1 className="text-3xl font-light text-gray-800 tracking-tight mb-2">Welcome Back</h1>
                         <p className="text-gray-400 font-light text-sm">Please sign in to access your dashboard</p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                         ...
                         <div className="flex justify-end">
                              <Link href="/admin/forgot-password" className="text-[11px] text-primary hover:text-primary/80 font-bold uppercase tracking-wider">Forgot Password?</Link>
                         </div>
