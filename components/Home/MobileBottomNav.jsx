      ...
      <div className="relative pointer-events-auto">
        ...
        <div className="bg-[#023120] rounded-t-[3rem] pb-safe pt-2 px-6 shadow-[0_-5px_15px_rgba(0,0,0,0.1)]">
          <div className="flex justify-between items-end h-16 w-full max-w-sm mx-auto pb-4 px-2">
            ...
            <Link
              href="/admin"
              className="flex flex-col items-center justify-center w-14 text-gray-400 hover:text-white active:text-white transition-colors gap-1 mr-4"
            >
              <BiUser size={22} />
            ...
            <div className="absolute left-1/2 -top-6 -translate-x-1/2">
              <div className="relative">
                ...
                <Link
                  href="/dna-test"
                  className="relative flex items-center justify-center w-16 h-16 bg-secondary rounded-full shadow-lg text-white hover:scale-105 transition-transform"
                >
                  <FaDna size={28} />
                </Link>
              </div>
            ...
            <Link
              href="/track"
              className="flex flex-col items-center justify-center w-14 text-gray-400 hover:text-white active:text-white transition-colors gap-1 ml-4"
            >
