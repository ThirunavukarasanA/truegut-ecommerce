...
export default function AdminSidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`w-64 h-screen bg-white text-font-title fixed left-0 top-0 flex flex-col shadow-xl z-50 transition-all duration-300 overflow-hidden border-r border-gray-100 
      ...
      >
        <div className="h-16 flex items-center justify-center border-b border-gray-100 bg-white/80 backdrop-blur-sm shrink-0">
          <h1 className="text-xl font-bold tracking-wider text-transparent bg-clip-text bg-linear-to-r from-primary to-secondary">
            TRUEGUT
