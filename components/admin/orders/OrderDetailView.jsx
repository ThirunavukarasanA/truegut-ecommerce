...
export default function OrderDetailView({ orderId, onBack, refreshList }) {
  ...
  // Shiprocket Form
  const [shiprocketDetails, setShiprocketDetails] = useState({
    weight: "",
    length: "",
    breadth: "",
    height: "",
  ...
  const handleShipOrder = async () => {
    if (shipMode === "Local") {
      if (!localDetails.courierName)
        return toast.error("Courier Name is required");
    }
    if (shipMode === "Shiprocket") {
      if (!shiprocketDetails.weight)
        return toast.error("Package weight is required for Shiprocket");
    }
    ...
    try {
      const payload = {
        mode: shipMode,
        ...(shipMode === "Local" ? localDetails : shiprocketDetails),
      };
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {["Processing", "Shipped"].includes(order.status) && (
            <button
              onClick={() => {
                ...
                if (order.deliveryDetails) {
                  ...
                  setShiprocketDetails({
                    weight: order.deliveryDetails.weight || "",
                    length: order.deliveryDetails.length || "",
                    breadth: order.deliveryDetails.breadth || "",
                    height: order.deliveryDetails.height || "",
                    pickupLocation:
                      order.deliveryDetails.pickupLocation || "Primary",
                  });
                }
              }}
            ...
            >
              ...
              {order.status === "Shipped" ? "Update Shipment" : "Ship Order"}
            </button>
          )}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div className="divide-y divide-gray-50">
              {order.items.map((item, idx) => (
                <div
                  key={idx}
                  className="p-6 flex flex-col sm:flex-row gap-6 hover:bg-gray-50/30 transition-colors"
                >
                  ...
                  <div className="flex-1 min-w-0 py-1">
                    ...
                    <div className="flex items-center justify-between mt-4">
                      <div className="text-sm text-gray-500 font-medium">
                        {item.quantity} x {settings.currency.symbol}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 bg-gray-50 rounded-xl border border-gray-100">
                  ...
                  <div className="font-medium text-gray-900 flex items-center gap-2">
                    <span
                      className={`w-2 h-2 rounded-full ${order.paymentStatus === "Paid" ? "bg-green-500" : "bg-orange-500"}`}
                    ></span>
                    {order.paymentStatus}
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-3 p-4 rounded-xl bg-blue-50 border border-blue-100">
                    ...
                    <div className="text-sm">
                      <p className="font-semibold text-blue-800 mb-0.5">
                        Shiprocket Auto-Shipping
                      </p>
                      <p className="text-blue-600 text-xs leading-relaxed">
                        An AWB code will be auto-generated and the best courier
                        will be assigned. Ensure your Shiprocket API credentials
                  ...
                  <div className="bg-gray-50 p-5 rounded-xl border border-gray-100 space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        min="0.1"
                        className="w-full px-3 py-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm shadow-sm"
                        value={shiprocketDetails.weight}
                        onChange={(e) =>
                          setShiprocketDetails({
                            ...shiprocketDetails,
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          min="1"
                          className="w-full px-3 py-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm shadow-sm"
                          value={shiprocketDetails.length}
                          onChange={(e) =>
                            setShiprocketDetails({
                              ...shiprocketDetails,
                      ...
                      <div>
                        ...
                        <input
                          ...
                          min="1"
                          className="w-full px-3 py-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm shadow-sm"
                          value={shiprocketDetails.breadth}
                          onChange={(e) =>
                            setShiprocketDetails({
                              ...shiprocketDetails,
                      ...
                      <div>
                        ...
                        <input
                          ...
                          min="1"
                          className="w-full px-3 py-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm shadow-sm"
                          value={shiprocketDetails.height}
                          onChange={(e) =>
                            setShiprocketDetails({
                              ...shiprocketDetails,
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        className="w-full px-3 py-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm shadow-sm"
                        value={shiprocketDetails.pickupLocation}
                        onChange={(e) =>
                          setShiprocketDetails({
                            ...shiprocketDetails,
                        ...
                        placeholder="Primary (from Shiprocket dashboard)"
                      />
                    </div>
                  </div>
                </div>
