...
export default function WhatsAppButton() {
  ...
  return (
    <Link
      ...
      className="fixed bottom-32 right-6 md:bottom-10 md:right-10 z-40 bg-[#25D366] text-white p-4 rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.3)] hover:scale-110 transition-transform duration-300 flex items-center justify-center group"
